...
public class MessageService {
    ...
    public MessageService(MongoTemplate mongoTemplate, RabbitTemplate rabbitTemplate,
                          ...
                          FileFeedService fileFeedService) {
    ...
    public Map<String, Object> sendMessage(Long fromUserId, String conversationId, int convType,
        ...
        if (extra != null && extra.containsKey("fileName")) {
            ...
            try {
                fileFeedService.recordFile(fromUserId, fromUserId, conversationId, convType,
                        (String) extra.get("fileName"), fileSize, filtered, messageType, messageId);
            } catch (Exception e) {
                log.warn("写入 file_feed 失败: {}", e.getMessage());
            }
        }
