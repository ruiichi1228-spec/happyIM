package com.happyim.ws.handler;
...
public class ChatWebSocketHandler extends TextWebSocketHandler {
    ...
    public String getCurrentConversation(Long userId) {
        ...
        return (String) session.getAttributes().get("currentConversation");
    }
    ...
    public void pushMessage(Long userId, Map<String, Object> payload) throws Exception {
        WebSocketSession session = sessions.get(userId);
    ...
    public void pushNotification(Long userId, Map<String, Object> data) throws Exception {
        WebSocketSession session = sessions.get(userId);
        if (session != null && session.isOpen()) {
    ...
    public void pushEvent(Long userId, Map<String, Object> data) {
        try {
            ...
            log.error("推送事件失败: userId={}, {}", userId, e.getMessage());
        }
    }
